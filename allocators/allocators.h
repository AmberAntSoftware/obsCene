...
#define OBC_ALLOC_UNITS_1 OBC_ALLOCATOR_META_CHUNKSIZE*META_BITS*OBC_ALLOC_UNITS_0
#define OBC_ALLOC_UNITS_2 OBC_ALLOCATOR_META_CHUNKSIZE*META_BITS*OBC_ALLOC_UNITS_1
#define OBC_ALLOC_UNITS_3 OBC_ALLOCATOR_META_CHUNKSIZE*META_BITS*OBC_ALLOC_UNITS_2
