...
void *OBC_memswap(void * __restrict ptr0, void * __restrict ptr1, size_t sizeInBytes){
	...
	if(sizeInBytes >= sizeof(X_X_LONGEST)){
		do{
			...
			tmpA.tmp0 = *((X_X_LONGEST*)((ptr0+sizeInBytes)));
			tmpB.tmp0 = *((X_X_LONGEST*)((ptr1+sizeInBytes)));

            *((X_X_LONGEST*)((ptr0+sizeInBytes))) = tmpB.tmp0;
            *((X_X_LONGEST*)((ptr1+sizeInBytes))) = tmpA.tmp0;
    ...
    if(sizeInBytes >= sizeof(unsigned int)){
        do{
            ...
            tmpA.tmp1 = *((unsigned int*)((ptr0+sizeInBytes)));
			tmpB.tmp1 = *((unsigned int*)((ptr1+sizeInBytes)));

            *((unsigned int*)((ptr0+sizeInBytes))) = tmpB.tmp1;
            *((unsigned int*)((ptr1+sizeInBytes))) = tmpA.tmp1;
    ...
    if(sizeInBytes){
        ...
        do{
            ...
            tmpA.tmp2 = *((unsigned char*)((ptr0+sizeInBytes)));
			tmpB.tmp2 = *((unsigned char*)((ptr1+sizeInBytes)));

            *((unsigned char*)((ptr0+sizeInBytes))) = tmpB.tmp2;
            *((unsigned char*)((ptr1+sizeInBytes))) = tmpA.tmp2;
